package com.example.physical_activity_monitoring_system_app.adapters
...
class RunAdapter : RecyclerView.Adapter<RunAdapter.RunViewHolder>() {
    ...
    override fun onBindViewHolder(holder: RunViewHolder, position: Int) {
        ...
        holder.itemView.apply {
            ...
            tvTime.text = TrackingUtility.getFormattedStopWatchTime(run.timeInMilisec)

            val burnedCalories = "${run.burnedCalories}kcal"
            tvCalories.text = burnedCalories
        }
    }
